...
import argparse
import pcpp
from metal_test import Engine, read_symbols
from subprocess import PIPE, Popen, check_output
from metal_test.preprocessor import PreprocessedSource
...
engine = Engine(binary=args.binary, input=p.stdout, output=p.stderr, symbols=symbols, addr2line=args.addr2line, preprocessed_source=preproc)
